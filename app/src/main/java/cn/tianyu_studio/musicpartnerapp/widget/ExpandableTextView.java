package cn.tianyu_studio.musicpartnerapp.widget;
...
//        mStateTv.setCompoundDrawablesWithIntrinsicBounds(mCollapsed ? mExpandDrawable : mCollapseDrawable, null, null, null);
        mStateTv.setCompoundDrawables(mCollapsed ? mExpandDrawable : mCollapseDrawable, null, null, null);
...
//        mStateTv.setCompoundDrawablesWithIntrinsicBounds(mCollapsed ? mExpandDrawable : mCollapseDrawable, null, null, null);
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mExpandDrawable.setBounds(0, 0, 30, 30);
        mCollapseDrawable.setBounds(0, 0, 30, 30);
        typedArray.recycle();
